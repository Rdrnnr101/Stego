...
(function oneko() {
  ...
  function init() {
	...
	nekoEl.style.transform = "scale(0.7)"; 
  ...
  function frame() {
    ...
    nekoPosX = Math.min(Math.max(spriteSize / 2, nekoPosX), window.innerWidth - spriteSize / 2);
	nekoPosY = Math.min(Math.max(spriteSize / 2, nekoPosY), window.innerHeight - spriteSize / 2);
